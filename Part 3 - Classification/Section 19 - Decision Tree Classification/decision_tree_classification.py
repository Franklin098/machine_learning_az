...
# -*- coding: utf-8 -*-
"""
Created on Fri Feb  7 22:36:29 2020
...
This Algoritm is not Based ond Euclidian Distance, so is not necessary to do Feature Scaling
But we are going to use to plot, bot we can avoid it.
"""
...
"""
We can see that the model is trying to fit everything, to put every single user in each category

Soo it feels that ther it is overfitting !!:(
"""
